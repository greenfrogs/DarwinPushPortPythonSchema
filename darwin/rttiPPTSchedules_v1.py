...
#
# Generated Sat Jul 22 23:53:51 2023 by generateDS.py version 2.42.2.
...
from .rttiPPTSchedules_v1 import AssocService
from .rttiPPTSchedules_v1 import Association
from .rttiPPTSchedules_v1 import DT
from .rttiPPTSchedules_v1 import DeactivatedSchedule
from .rttiPPTSchedules_v1 import IP
from .rttiPPTSchedules_v1 import OPDT
from .rttiPPTSchedules_v1 import OPIP
from .rttiPPTSchedules_v1 import OPOR
from .rttiPPTSchedules_v1 import OR
from .rttiPPTSchedules_v1 import PP
...
class AssocService(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='AssocService', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='AssocService'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='AssocService', fromsubclass_=False, pretty_print=True):
        pass
...
class Association(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v13" ', name_='Association', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='Association'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v13" ', name_='Association', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class OR(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, wta=None, wtd=None, fd=None, tpl=None, act='  ', planAct=None, can=False, pta=None, ptd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OR', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OR'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.ptd is not None and 'ptd' not in already_processed:
            already_processed.add('ptd')
            outfile.write(' ptd=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.ptd), input_name='ptd')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OR', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPOR(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, wta=None, wtd=None, tpl=None, act='  ', planAct=None, can=False, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPOR', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPOR'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.can and 'can' not in already_processed:
            already_processed.add('can')
            outfile.write(' can="%s"' % self.gds_format_boolean(self.can, input_name='can'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPOR', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class IP(GeneratedsSuper):
    ...
    wta -- Working Scheduled Time of Arrival
    wtd -- Working Scheduled Time of Departure
    rdelay -- A delay value that is implied by a change to the service's route. This value has been added to the forecast lateness of the service at the previous schedule location when calculating the expected lateness of arrival at this location.
    fd -- TIPLOC of False Destination to be used at this location
    ...
    subclass = None
    superclass = None
    def __init__(self, wta=None, wtd=None, rdelay='0', fd=None, tpl=None, act='  ', planAct=None, can=False, pta=None, ptd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='IP', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='IP'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.ptd is not None and 'ptd' not in already_processed:
            already_processed.add('ptd')
            outfile.write(' ptd=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.ptd), input_name='ptd')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='IP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPIP(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, wta=None, wtd=None, rdelay='0', tpl=None, act='  ', planAct=None, can=False, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPIP', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPIP'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.can and 'can' not in already_processed:
            already_processed.add('can')
            outfile.write(' can="%s"' % self.gds_format_boolean(self.can, input_name='can'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPIP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class PP(GeneratedsSuper):
    ...
    rdelay -- A delay value that is implied by a change to the service's route. This value has been added to the forecast lateness of the service at the previous schedule location when calculating the expected lateness of passing this location.
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, wtp=None, rdelay='0', tpl=None, act='  ', planAct=None, can=False, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='PP', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='PP'):
        if self.wtp is not None and 'wtp' not in already_processed:
            already_processed.add('wtp')
            outfile.write(' wtp=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wtp), input_name='wtp')), ))
        if self.rdelay != 0 and 'rdelay' not in already_processed:
        ...
        if self.can and 'can' not in already_processed:
            already_processed.add('can')
            outfile.write(' can="%s"' % self.gds_format_boolean(self.can, input_name='can'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='PP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class DT(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, wta=None, wtd=None, rdelay='0', tpl=None, act='  ', planAct=None, can=False, pta=None, ptd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='DT', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='DT'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.ptd is not None and 'ptd' not in already_processed:
            already_processed.add('ptd')
            outfile.write(' ptd=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.ptd), input_name='ptd')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='DT', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPDT(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPDT', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPDT'):
        if self.wta is not None and 'wta' not in already_processed:
            already_processed.add('wta')
            outfile.write(' wta=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.wta), input_name='wta')), ))
        if self.wtd is not None and 'wtd' not in already_processed:
        ...
        if self.can and 'can' not in already_processed:
            already_processed.add('can')
            outfile.write(' can="%s"' % self.gds_format_boolean(self.can, input_name='can'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='OPDT', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Schedule(GeneratedsSuper):
    ...
    isActive -- Indicates if this service is active in Darwin. Note that schedules should be assumed to be inactive until a message is received to indicate otherwise.
    ...
    subclass = None
    superclass = None
    def __init__(self, rid=None, uid=None, trainId=None, ssd=None, toc=None, status='P', trainCat='OO', isPassengerSvc=True, isActive=True, deleted=False, isCharter=False, OR=None, OPOR=None, IP=None, OPIP=None, PP=None, DT=None, OPDT=None, cancelReason=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v13"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Schedule', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='Schedule'):
        if self.rid is not None and 'rid' not in already_processed:
            already_processed.add('rid')
            outfile.write(' rid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.rid), input_name='rid')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v13"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Schedule', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DeactivatedSchedule(GeneratedsSuper):
    """DeactivatedSchedule -- Notification that a Train Schedule is now deactivated in Darwin.
    rid -- RTTI unique Train ID
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='DeactivatedSchedule', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DeactivatedSchedule':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DeactivatedSchedule')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DeactivatedSchedule', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='DeactivatedSchedule'):
        if self.rid is not None and 'rid' not in already_processed:
            already_processed.add('rid')
            outfile.write(' rid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.rid), input_name='rid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v1"', name_='DeactivatedSchedule', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v13"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTSchedules_v1 import *\n\n')
        sys.stdout.write('import rttiPPTSchedules_v1 as model_\n\n')
