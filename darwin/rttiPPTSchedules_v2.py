...
from .rttiPPTSchedules_v2 import AssocService
from .rttiPPTSchedules_v2 import Association
from .rttiPPTSchedules_v2 import DT
from .rttiPPTSchedules_v2 import DeactivatedSchedule
from .rttiPPTSchedules_v2 import IP
from .rttiPPTSchedules_v2 import OPDT
from .rttiPPTSchedules_v2 import OPIP
from .rttiPPTSchedules_v2 import OPOR
from .rttiPPTSchedules_v2 import OR
from .rttiPPTSchedules_v2 import PP
from .rttiPPTSchedules_v2 import Schedule
...
class AssocService(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='AssocService', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='AssocService', fromsubclass_=False, pretty_print=True):
        pass
...
class Association(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='Association', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='Association', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class OR(GeneratedsSuper):
    ...
    def __init__(self, wta=None, wtd=None, fd=None, tpl=None, act='  ', planAct=None, can=False, fid=None, pta=None, ptd=None, avgLoading=None, gds_collector_=None, **kwargs_):
        ...
        self.ptd = _cast(None, ptd)
        self.ptd_nsprefix_ = None
        self.avgLoading = _cast(int, avgLoading)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OR', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OR', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPOR(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPOR', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPOR'):
        ...
        if self.fid is not None and 'fid' not in already_processed:
            already_processed.add('fid')
            outfile.write(' fid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.fid), input_name='fid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPOR', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class IP(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='IP', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='IP'):
        ...
        if self.avgLoading is not None and 'avgLoading' not in already_processed:
            already_processed.add('avgLoading')
            outfile.write(' avgLoading="%s"' % self.gds_format_integer(self.avgLoading, input_name='avgLoading'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='IP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPIP(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPIP', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPIP'):
        ...
        if self.fid is not None and 'fid' not in already_processed:
            already_processed.add('fid')
            outfile.write(' fid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.fid), input_name='fid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPIP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class PP(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='PP', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='PP'):
        ...
        if self.fid is not None and 'fid' not in already_processed:
            already_processed.add('fid')
            outfile.write(' fid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.fid), input_name='fid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='PP', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class DT(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='DT', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='DT'):
        ...
        if self.avgLoading is not None and 'avgLoading' not in already_processed:
            already_processed.add('avgLoading')
            outfile.write(' avgLoading="%s"' % self.gds_format_integer(self.avgLoading, input_name='avgLoading'))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='DT', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class OPDT(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPDT', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='OPDT'):
        ...
        if self.fid is not None and 'fid' not in already_processed:
            already_processed.add('fid')
            outfile.write(' fid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.fid), input_name='fid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='OPDT', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class Schedule(GeneratedsSuper):
    ...
    rsid -- Retail Service Identifier. Note that this may be either a full 8-character "portion identifier", or a base 6-character identifier, according to the available information provided to Darwin.
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Schedule', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Schedule', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DeactivatedSchedule(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='DeactivatedSchedule', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='DeactivatedSchedule'):
        if self.rid is not None and 'rid' not in already_processed:
            already_processed.add('rid')
            outfile.write(' rid=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.rid), input_name='rid')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"', name_='DeactivatedSchedule', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTSchedules_v2 import *\n\n')
        sys.stdout.write('import rttiPPTSchedules_v2 as model_\n\n')
