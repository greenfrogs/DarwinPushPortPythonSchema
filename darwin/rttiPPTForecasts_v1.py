...
from .rttiPPTForecasts_v1 import PlatformData
from .rttiPPTForecasts_v1 import TS
from .rttiPPTForecasts_v1 import TSLocation
from .rttiPPTForecasts_v1 import TSTimeData
from .rttiPPTForecasts_v1 import TrainOrder
from .rttiPPTForecasts_v1 import TrainOrderData
from .rttiPPTForecasts_v1 import TrainOrderItem

class TrainOrderItem(GeneratedsSuper):
    """TrainOrderItem -- Describes the identifier of a train in the train order
    rid -- For trains in the train order where the train is the Darwin timetable, it will be identified by its RID
    One or more scheduled times to identify the instance of the location in the train schedule for which the train order is set.
    trainID -- Where a train in the train order is not in the Darwin timetable, a Train ID (headcode) will be supplied
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='TrainOrderItem', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TrainOrderItem':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TrainOrderItem')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TrainOrderItem', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='TrainOrderItem'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='TrainOrderItem', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'rid':
            obj_ = rid.factory(parent_object_=self)
...
class rid(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rid)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rid.subclass:
            return rid.subclass(*args_, **kwargs_)
        else:
            return rid(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_RIDType(self, value):
        result = True
        # Validate type RIDType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='rid', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rid')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rid':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rid')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rid'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='rid', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TrainOrderData(GeneratedsSuper):
    """TrainOrderData -- Defines the sequence of trains making up the train order
    first -- The first train in the train order.
    second -- The second train in the train order.
    third -- The third train in the train order.
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11" ', name_='TrainOrderData', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TrainOrderData':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TrainOrderData')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TrainOrderData', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='TrainOrderData'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11" ', name_='TrainOrderData', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TrainOrder(GeneratedsSuper):
    """TrainOrder -- Defines the expected Train order at a platform
    tiploc -- The tiploc where the train order applies
    crs -- The CRS code of the station where the train order applies
    platform -- The platform number where the train order applies
    clear -- Clear the current train order
    
    """
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, tiploc=None, crs=None, platform=None, set_=None, clear=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TrainOrder', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TrainOrder':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TrainOrder')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TrainOrder', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='TrainOrder'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TrainOrder', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class clear(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='clear', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'clear':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='clear')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='clear', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='clear'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='clear', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class PlatformData(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='PlatformData', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='PlatformData', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TSTimeData(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, et=None, at=None, atRemoved=False, etmin=None, etUnknown=False, delayed=False, src=None, srcInst=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='TSTimeData', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1"', name_='TSTimeData', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TSLocation(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TSLocation', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='TSLocation'):
        ...
        if self.ptd is not None and 'ptd' not in already_processed:
            already_processed.add('ptd')
            outfile.write(' ptd=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.ptd), input_name='ptd')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TSLocation', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TS(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11" ', name_='TS', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v1" xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v11" ', name_='TS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'TrainOrderItem'
        rootClass = TrainOrderItem
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTForecasts_v1 import *\n\n')
        sys.stdout.write('import rttiPPTForecasts_v1 as model_\n\n')
