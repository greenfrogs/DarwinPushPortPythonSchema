...
from .rttiPPTSchema_v14 import DataResponse
...
class DataResponse(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14" xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"  xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"  xmlns:sm="http://www.thalesgroup.com/rtti/PushPort/StationMessages/v1"  xmlns:ta="http://www.thalesgroup.com/rtti/PushPort/TrainAlerts/v1"  xmlns:tor="http://www.thalesgroup.com/rtti/PushPort/TrainOrder/v1"  xmlns:td="http://www.thalesgroup.com/rtti/PushPort/TDData/v1"  xmlns:alm="http://www.thalesgroup.com/rtti/PushPort/Alarms/v1" ', name_='DataResponse', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DataResponse'):
        ...
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14" xmlns:sch="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"  xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"  xmlns:sm="http://www.thalesgroup.com/rtti/PushPort/StationMessages/v1"  xmlns:ta="http://www.thalesgroup.com/rtti/PushPort/TrainAlerts/v1"  xmlns:tor="http://www.thalesgroup.com/rtti/PushPort/TrainOrder/v1"  xmlns:td="http://www.thalesgroup.com/rtti/PushPort/TDData/v1"  xmlns:alm="http://www.thalesgroup.com/rtti/PushPort/Alarms/v1" ', name_='DataResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Pport(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Pport', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Pport', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class QueryTimetable(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='QueryTimetable', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='QueryTimetable'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='QueryTimetable', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TimeTableId(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='TimeTableId', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='TimeTableId', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class GetSnapshotReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='GetSnapshotReq', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='GetSnapshotReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class GetFullSnapshotReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='GetFullSnapshotReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GetFullSnapshotReq'):
        if self.viaftp and 'viaftp' not in already_processed:
            already_processed.add('viaftp')
            outfile.write(' viaftp="%s"' % self.gds_format_boolean(self.viaftp, input_name='viaftp'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='GetFullSnapshotReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class StartUpdateReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='StartUpdateReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StartUpdateReq'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='StartUpdateReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class StopUpdateReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='StopUpdateReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StopUpdateReq'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='StopUpdateReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class FailureResp(StatusType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='FailureResp', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='FailureResp', fromsubclass_=False, pretty_print=True):
...
class uR(DataResponse):
    ...
    def __init__(self, schedule=None, deactivated=None, association=None, TS=None, OW=None, trainAlert=None, trainOrder=None, trackingID=None, alarm=None, updateOrigin=None, requestSource=None, requestID=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='uR', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='uR'):
        ...
        if self.requestID is not None and 'requestID' not in already_processed:
            already_processed.add('requestID')
            outfile.write(' requestID=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.requestID), input_name='requestID')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"', name_='uR', fromsubclass_=False, pretty_print=True):
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v14"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTSchema_v14 import *\n\n')
        sys.stdout.write('import rttiPPTSchema_v14 as model_\n\n')
