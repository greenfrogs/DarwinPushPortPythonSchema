...
class DisruptionReasonType(GeneratedsSuper):
    """DisruptionReasonType -- Type used to represent a cancellation or late running reason
    tiploc -- Optional TIPLOC where the reason refers to, e.g. "signalling failure at Cheadle Hulme".
    near -- If true, the tiploc attribute should be interpreted as "near", e.g. "signalling failure near Cheadle Hulme".
    ...
    def validate_ReasonCodeType(self, value):
        result = True
        # Validate type ReasonCodeType, a restriction on xs:short.
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"', name_='DisruptionReasonType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DisruptionReasonType':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DisruptionReasonType')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DisruptionReasonType'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"', name_='DisruptionReasonType', fromsubclass_=False, pretty_print=True):
        pass
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'DisruptionReasonType'
        rootClass = DisruptionReasonType
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTCommonTypes_v1 import *\n\n')
        sys.stdout.write('import rttiPPTCommonTypes_v1 as model_\n\n')
