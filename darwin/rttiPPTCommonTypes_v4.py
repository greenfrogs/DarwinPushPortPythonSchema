...
class ToiletAvailabilityType(GeneratedsSuper):
    """ToiletAvailabilityType -- The availability of a toilet in coach formation data. If no availability is supplied, it should be assumed to have the value "Unknown".
    status -- The service status of this toilet. E.g. "Unknown", "InService" or "NotInService".
    ...
    def validate_ToiletType(self, value):
        result = True
        # Validate type ToiletType, a restriction on xs:string.
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:ct4="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4"', name_='ToiletAvailabilityType', pretty_print=True):
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ToiletAvailabilityType':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ToiletAvailabilityType')
        outfile.write('>')
        self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_, pretty_print=pretty_print)
        outfile.write(self.convert_unicode(self.valueOf_))
        outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='ToiletAvailabilityType'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:ct4="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4"', name_='ToiletAvailabilityType', fromsubclass_=False, pretty_print=True):
        pass
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'ToiletAvailabilityType'
        rootClass = ToiletAvailabilityType
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTCommonTypes_v4 import *\n\n')
        sys.stdout.write('import rttiPPTCommonTypes_v4 as model_\n\n')
