...
from .rttiPPTForecasts_v3 import PlatformData
from .rttiPPTForecasts_v3 import TS
from .rttiPPTForecasts_v3 import TSLocation
from .rttiPPTForecasts_v3 import TSTimeData
...
class PlatformData(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"', name_='PlatformData', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"', name_='PlatformData', fromsubclass_=False, pretty_print=True):
        pass
...
class TSTimeData(GeneratedsSuper):
    ...
    atClass -- The class of the actual time.
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"', name_='TSTimeData', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"', name_='TSTimeData', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TSLocation(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TSLocation', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16"  xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='TSLocation', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TS(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='TS', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3" xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='TS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTForecasts_v3 import *\n\n')
        sys.stdout.write('import rttiPPTForecasts_v3 as model_\n\n')
