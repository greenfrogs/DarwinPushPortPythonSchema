...
from .rttiPPTCommonTypes_v4 import ToiletAvailabilityType
from .rttiPPTFormations_v2 import CoachData
from .rttiPPTFormations_v2 import CoachList
from .rttiPPTFormations_v2 import Formation
...
class ScheduleFormations(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='ScheduleFormations', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='ScheduleFormations', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Formation(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='Formation', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='Formation', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CoachList(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='CoachList', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='tns:', name_='CoachList'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v16" ', name_='CoachList', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CoachData(GeneratedsSuper):
    ...
    toilet -- The availability of a toilet in this coach. E.g. "Unknown", "None" , "Standard" or "Accessible". Note that other values may be supplied in the future without a schema change. If no toilet availability is supplied then it should be assumed to be "Unknown".
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:ct4="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Formations/v1"', name_='CoachData', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='tns:', namespacedef_='xmlns:fm2="http://www.thalesgroup.com/rtti/PushPort/Formations/v2" xmlns:ct4="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v4"  xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/Formations/v1"', name_='CoachData', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTFormations_v2 import *\n\n')
        sys.stdout.write('import rttiPPTFormations_v2 as model_\n\n')
