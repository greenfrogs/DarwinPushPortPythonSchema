...
from .rttiPPTForecasts_v3 import TS
...
from .rttiPPTSchema_v15 import DataResponse
...
from .rttiPPTTrainOrder_v1 import TrainOrder
...
class DataResponse(GeneratedsSuper):
    ...
    scheduleFormations -- Train Formation
    TS -- Train Status
    formationLoading -- Train Loading
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15" xmlns:sch3="http://www.thalesgroup.com/rtti/PushPort/Schedules/v3"  xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"  xmlns:fm="http://www.thalesgroup.com/rtti/PushPort/Formations/v1"  xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"  xmlns:sm="http://www.thalesgroup.com/rtti/PushPort/StationMessages/v1"  xmlns:ta="http://www.thalesgroup.com/rtti/PushPort/TrainAlerts/v1"  xmlns:tor="http://www.thalesgroup.com/rtti/PushPort/TrainOrder/v1"  xmlns:td="http://www.thalesgroup.com/rtti/PushPort/TDData/v1"  xmlns:alm="http://www.thalesgroup.com/rtti/PushPort/Alarms/v1" ', name_='DataResponse', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DataResponse'):
        ...
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15" xmlns:sch3="http://www.thalesgroup.com/rtti/PushPort/Schedules/v3"  xmlns:sch2="http://www.thalesgroup.com/rtti/PushPort/Schedules/v2"  xmlns:fm="http://www.thalesgroup.com/rtti/PushPort/Formations/v1"  xmlns:for="http://www.thalesgroup.com/rtti/PushPort/Forecasts/v3"  xmlns:sm="http://www.thalesgroup.com/rtti/PushPort/StationMessages/v1"  xmlns:ta="http://www.thalesgroup.com/rtti/PushPort/TrainAlerts/v1"  xmlns:tor="http://www.thalesgroup.com/rtti/PushPort/TrainOrder/v1"  xmlns:td="http://www.thalesgroup.com/rtti/PushPort/TDData/v1"  xmlns:alm="http://www.thalesgroup.com/rtti/PushPort/Alarms/v1" ', name_='DataResponse', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'schedule':
            ...
            obj_ = ScheduleFormations.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class Pport(GeneratedsSuper):
    ...
    uR -- Update Response
    updateOrigin -- A string describing the type of system that originated this update, e.g. "CIS" or "Darwin".
    requestSource -- The source instance that generated this update, usually a CIS instance.
    requestID -- The DCISRequestID value provided by the originator of this update. Used in conjunction with the requestSource attribute to ensure uniqueness
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Pport', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15" xmlns:None="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1"  xmlns:ct="http://www.thalesgroup.com/rtti/PushPort/CommonTypes/v1" ', name_='Pport', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class QueryTimetable(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='QueryTimetable', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='QueryTimetable'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='QueryTimetable', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class TimeTableId(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='TimeTableId', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='TimeTableId', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class GetSnapshotReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='GetSnapshotReq', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='GetSnapshotReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class GetFullSnapshotReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='GetFullSnapshotReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GetFullSnapshotReq'):
        if self.viaftp and 'viaftp' not in already_processed:
            already_processed.add('viaftp')
            outfile.write(' viaftp="%s"' % self.gds_format_boolean(self.viaftp, input_name='viaftp'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='GetFullSnapshotReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class StartUpdateReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='StartUpdateReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StartUpdateReq'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='StartUpdateReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class StopUpdateReq(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='StopUpdateReq', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StopUpdateReq'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='StopUpdateReq', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class FailureResp(StatusType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='FailureResp', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='FailureResp', fromsubclass_=False, pretty_print=True):
...
class uR(DataResponse):
    ...
    def __init__(self, schedule=None, deactivated=None, association=None, scheduleFormations=None, TS=None, formationLoading=None, OW=None, trainAlert=None, trainOrder=None, trackingID=None, alarm=None, updateOrigin=None, requestSource=None, requestID=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("uR"), self).__init__(schedule, deactivated, association, scheduleFormations, TS, formationLoading, OW, trainAlert, trainOrder, trackingID, alarm,  **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='uR', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='uR'):
        ...
        if self.requestID is not None and 'requestID' not in already_processed:
            already_processed.add('requestID')
            outfile.write(' requestID=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.requestID), input_name='requestID')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"', name_='uR', fromsubclass_=False, pretty_print=True):
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:tns="http://www.thalesgroup.com/rtti/PushPort/v15"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from rttiPPTSchema_v15 import *\n\n')
        sys.stdout.write('import rttiPPTSchema_v15 as model_\n\n')
